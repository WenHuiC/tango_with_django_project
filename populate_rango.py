...
def populate():
    ...
    python_pages = [
        ...
        {'title':'How to Think like a Computer Scientist',
         'url':'http://www.greenteapress.com/thinkpython/', 'views':44},
    ...
    django_pages = [
        ...
        {'title':'How to Tango with Django',
         'url':'http://www.tangowithdjango.com/', 'views':74}
    ]
    ...
    for cat, cat_data in cats.items():
        ...
        for p in cat_data['pages']:
            ...
            # add_cat(c, c['views'], c['likes']) -- not working
...
# function
# get_or_create() method for creating model instanecs in the population script
# [0] after get_or_create() returns the object reference only
...
# function will not execute unless is called
